...
Xem sau: [Tính năng chi tiết](./PhoenixKey-Smartsend-Vi-Feat.md) · Toán/bất biến: [PhoenixKey-Smartsend-Math.md](./PhoenixKey-Smartsend-Math.md) (12 bất biến kiểm chứng được đánh mã SS-1..12, và một định lý chứng minh "không ai mất tiền do lỗi cơ chế" — gọi tắt Định lý No-loss)
...
Xem sau: [Tính năng chi tiết](./PhoenixKey-Protectme-Vi-Feat.md) · Toán/bất biến: [PhoenixKey-Protectme-Math.md](./PhoenixKey-Protectme-Math.md) (bất biến mức trần theo sự cố mã `I-PROT-INCIDENT-CAP`, và 3 quyết định tham số kinh tế còn chờ chốt đánh mã nội bộ PROT-4/PROT-10/PROT-11)
