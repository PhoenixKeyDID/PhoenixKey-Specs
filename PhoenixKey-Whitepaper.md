...
> **Ghi chú đọc:** các mô tả dưới đây là **thiết kế đích** (kim chỉ nam). Một số cơ chế an toàn cốt lõi — van chống rút-sạch của Rebirthme, hòm ký-quỹ của Smartsend, cổng chi-trả của Protectme — đang trong giai đoạn xây. Xem trạng thái thật hôm nay ở [PhoenixKey-STATUS.md](./PhoenixKey-STATUS.md) trước khi coi bất kỳ danh tính nào là an toàn cho giá-trị lớn.
...
> (\*) Với danh tính **Tổ chức / Dịch vụ**, tính chất này đã đủ vì con dấu luôn đòi chữ ký của "cha" khi đúc (tạo ra lần đầu trên chuỗi — xem "Đúc (mint)" ở bảng từ điển mục 1.5). Với danh tính **Cá nhân**, một lớp tính-độc-nhất trên chuỗi đang được xây (đóng một lỗ hiếm gặp: kẻ xấu có thể đúc một danh tính mạo danh, trùng tên với bạn) — xem tiến độ ở [PhoenixKey-STATUS.md](./PhoenixKey-STATUS.md). Trước khi lớp đó xong, chỉ nên dùng danh tính Cá nhân cho việc không giữ giá-trị lớn.
