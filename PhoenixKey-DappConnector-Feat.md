...
> **Nguồn đối chiếu code thật** (mã trong kho ứng dụng PhoenixKey, chưa lên nhánh chính):
...
Nguồn thiết kế nội bộ (không công khai) + code tham chiếu trực tiếp (kho ứng dụng PhoenixKey, chưa lên nhánh chính):
