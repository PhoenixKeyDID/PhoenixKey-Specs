# PhoenixKey — Safesend: Nút "hoàn-tác" cho giao-dịch, gửi-có-bảo-vệ

> **Tài liệu này viết cho ai:** người dùng PhoenixKey và đội sản-phẩm — KHÔNG phải kỹ sư hay auditor. Mục tiêu: hiểu **Safesend là gì**, giải quyết gì, dùng ra sao, bằng ngôn ngữ đời thường.
> **Module:** Safesend (gửi-có-bảo-vệ). **Loại doc:** Feature (hướng người dùng/sản phẩm). **Ngày:** 2026-07-09.
> Đặc-tả toán ở [PhoenixKey-Safesend-Math.md](./PhoenixKey-Safesend-Math.md); kỹ-thuật ở [PhoenixKey-Safesend-Tech.md](./PhoenixKey-Safesend-Tech.md); điều-hành ở [PhoenixKey-Safesend-Exec.md](./PhoenixKey-Safesend-Exec.md).
> Safesend dùng chung hạ-tầng ví (`did_payment`), guardian và anti-drain của module **Rebirthme** — xem [PhoenixKey-Rebirthme-Vi-Feat.md](./PhoenixKey-Rebirthme-Vi-Feat.md).

---

## 1. Một câu là gì

**Safesend là cách gửi tiền có một "cửa-sổ để huỷ": khoản gửi được khoá tạm trong một hòm ký-quỹ; trong cửa-sổ đó bạn đổi ý thì huỷ và tiền hoàn về bạn, còn với khoản lớn thì người-nhận phải bấm đồng-ý mới nhận được. Gửi nhầm không còn là mất trắng.**

Hình dung đơn giản: chuyển tiền crypto bình-thường như **thả thư vào thùng thư không có nắp** — buông tay là đi luôn, sai địa chỉ cũng không đòi lại được. Safesend như **gửi bảo-đảm có thời-gian giữ tại bưu-điện** — trong lúc giữ, bạn còn kịp rút lại nếu ghi nhầm người nhận.
...
### Bước 1 — Bật Safesend khi gửi (tuỳ chọn)
...
Với khoản cần bảo-vệ, **Huỷ** không chỉ một chữ-ký gửi mà đòi đủ số **yếu-tố** đã cài trước: có thể là guardian ký, hoặc bằng-chứng **bối-cảnh** (khuôn mặt / ảnh-bí-mật / vị-trí thiết-bị) dạng ZK. Điểm cốt-tử: các yếu-tố này **không sinh ra từ cùng gốc với khoá gửi** — nên một lần lộ khoá gửi KHÔNG mở được luôn quyền huỷ.
...
## 5. Bảng cải-tiến (gửi thường vs Safesend)

| Điểm | Gửi crypto thường | Safesend (gửi-có-bảo-vệ) |
|---|---|---|
...
**Bạn cần:**
- Hiểu Safesend là **tuỳ chọn** — bật khi gửi khoản đáng lo, khoản nhỏ đời thường vẫn gửi thường cho nhanh.
...
**Hỏi: Safesend khác Protectme thế nào?**
Đáp: Safesend **NGĂN** tổn-thất TRƯỚC (cửa-sổ huỷ trước khi tiền đi hẳn); Protectme **PHỦ** tổn-thất SAU (bồi-hoàn khi đã mất). Hai cơ-chế khác trục — phòng-ngừa vs bồi-hoàn — và bổ-sung nhau.
...
**Hỏi: Kẻ trộm có khoá gửi của tôi thì Safesend chặn được không?**
Đáp: Muốn HUỶ khoản trong cửa-sổ cần yếu-tố **khác gốc khoá-gửi** (guardian/bối-cảnh), nên chỉ có khoá gửi thì kẻ trộm không lách được; guardian còn Freeze được hòm. Điều-kiện: bạn phải bật Safesend và cài yếu-tố huỷ **TRƯỚC** khi khoá bị lộ — bật sau khi đã mất khoá thì không cứu được khoản đã đi. Chống-trộm của Safesend còn dựa lớp anti-drain của Rebirthme làm nền.
...
**Hỏi: Gửi khoản nhỏ hằng ngày có phải qua Safesend không?**
Đáp: Không bắt-buộc. Safesend là opt-in; bật khi cần, còn lại gửi thường một chữ-ký đi ngay.
...
- **Bật-trước-khi-mất-khoá.** Safesend chỉ cứu được khoản gửi SAU khi bạn đã bật + cài yếu-tố huỷ. Bật sau khi khoá đã lộ không cứu được khoản đã đi — đây là giới-hạn bản-chất của mọi cơ-chế huỷ-trong-cửa-sổ, không phải lỗi thiếu tính-năng.
- **Chống-trộm của Safesend dựa lớp anti-drain** của module Rebirthme làm nền — hai lớp bổ-trợ nhau: anti-drain giới-hạn thiệt-hại nếu huỷ không kịp, Safesend cho cửa-sổ để huỷ trước. Đừng coi Safesend là lá chắn chống-trộm đủ một mình tách rời khỏi nền đó.
- **Yếu-tố bối-cảnh-ZK (khuôn mặt / ảnh-bí-mật / vị-trí)** dựa Spectra + Glint (đội VeData) — lớp này độc-lập, có thể dùng guardian-factor trước khi VeData sẵn-sàng.
...
**Nền tái-dùng:** hạ-tầng ví theo-DID `did_payment`, guardian-recovery theo ngưỡng + timelock + Cancel của module Rebirthme; Safesend cắm lên nền này, không dựng lại.
...
Tài-liệu cùng bộ: [PhoenixKey-Safesend-Math.md](./PhoenixKey-Safesend-Math.md), [PhoenixKey-Safesend-Tech.md](./PhoenixKey-Safesend-Tech.md), [PhoenixKey-Safesend-Exec.md](./PhoenixKey-Safesend-Exec.md).
