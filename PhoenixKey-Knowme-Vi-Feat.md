...
> Nội dung bám đặc-tả [PhoenixKey-Knowme-Math.md](./PhoenixKey-Knowme-Math.md) + [PhoenixKey-Knowme-Tech.md](./PhoenixKey-Knowme-Tech.md) + [PhoenixKey-Knowme-Exec.md](./PhoenixKey-Knowme-Exec.md); code tham chiếu `PhoenixKey-Frontend/src/lib/sdvc/`.
