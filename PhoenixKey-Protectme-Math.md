...
> - Đơn-vị CARP/MAGIC: [PhoenixKey-Math.md](./PhoenixKey-Math.md). Curve I-CURVE-4/5: [PhoenixKey-Rebirthme-Math.md](./PhoenixKey-Rebirthme-Math.md) + addendum Curve-Routing (CHƯA gộp vào Math.md).
>
