# PhoenixKey — Protectme: Lớp bồi hoàn cuối, phủ phần bị mất

> **Tài liệu này viết cho ai:** người dùng PhoenixKey và đội sản phẩm — KHÔNG phải kỹ sư
> hay auditor. Mục tiêu: hiểu Protectme **là gì**, phủ **cái gì / không phủ cái gì**, và
> hành trình bấm nút ra sao, bằng ngôn ngữ đời thường.
>
> **Module:** Protectme (Bảo hiểm phủ tài sản) · **Loại doc:** Feature (người dùng/sản phẩm)
> · **Ngày:** 2026-07-09.
>
...
lớp kia không kéo về được. Nó là lớp bồi hoàn **cuối cùng**, không phải lớp đầu.
...
## 3. Phủ cái gì — KHÔNG phủ cái gì (phần quan trọng nhất)
...
## 4. Hành trình của bạn — bấm gì, thấy gì

### Bước 1. Mua/bật bảo vệ
...
### Bước 2. Báo mất (mở yêu cầu bồi hoàn)
...
## 5. Kể bằng ẩn dụ: giống bảo hiểm nhà như thế nào
...
## 6. Bảng cải tiến — so với bảo hiểm crypto truyền thống

| Việc | Bảo hiểm crypto truyền thống | Protectme |
|---|---|---|
| Phủ bao nhiêu | Đền toàn bộ hoặc không đền gì (sàn custodial) → rủi ro đạo đức cao, phí cao | Chỉ phủ **phần dư** sau khi ví tự cứu → kỳ vọng chi nhỏ, phí khả thi |
| Cách tính phí | Phí phẳng một-rate-cho tất cả → chỉ user rủi ro cao mua, xoáy tử thần | Phí theo rủi ro thật; **giảm khi bật phòng ngự** → khuyến khích tự bảo vệ |
| Lỗi hệ thống vs sơ suất | Xử chung một kiểu | **Tách hai quỹ**: lỗi hệ thống phủ mạnh, sơ suất phủ hạn chế + bạn chịu một phần |
| Chi trả | Chi tức thì → dễ bị dàn cảnh rút ngay | Có **thời gian chờ + phản tố** trước khi tiền ra |
| Chống chi trùng | Thường không có → nạp trùng chi đôi | Mỗi yêu cầu chi **đúng một lần** (cơ chế chống chi trùng trên chuỗi) |
| Sau khi truy hồi được | Không rõ | Phần thu hồi trả lại quỹ — bạn không lời gấp đôi |

---

## 7. Quyền lợi và nghĩa vụ của bạn

**Quyền lợi:**
- Được bồi hoàn **phần dư** bị mất (trong trần loại nguyên nhân + giới hạn quỹ).
- Phí **giảm** khi bạn bật các lớp phòng ngự độc lập (chặn rút sạch, guardian khác thiết bị).
- Thông tin tổn thất **tự điền từ chuỗi** — bạn không phải tự chứng minh con số bị rút.

**Nghĩa vụ:**
- **Đóng phí đúng hạn.** Ngừng đóng quá ân hạn → mất bảo vệ ở kỳ kế tiếp.
- **Chờ hết thời gian hiệu lực** sau khi bật mới được phủ (chống mua bảo hiểm sau khi trộm).
- **Báo mất đúng hạn** (đề xuất 30 ngày).
- Với sơ suất: **chịu một phần** (mức miễn thường + co-pay).
- Nếu là DID chỉ một thiết bị: **bật chặn rút sạch** mới được phủ phần "sơ suất".
- **Hoàn phần truy hồi** về quỹ nếu sau này lấy lại được tài sản từ kẻ trộm.
...
## 9. Nói thật với bạn (ranh giới trung thực — thiết kế có chủ đích)

Đây là bản **đề xuất tính năng**. Đọc kỹ mục này trước khi tin bất kỳ con số nào:
...
- **Nhiều con số trong bài là ĐỀ XUẤT, chưa chốt:** các mốc thời gian (30 ngày báo mất,
  ...
  **chờ quyết định**.
- **Ranh giới quan trọng nhất còn chờ chốt** là **ngưỡng phân biệt "lỗi hệ thống" và "sơ
  suất người dùng"**. Ranh giới này quyết định bạn được phủ mạnh hay hạn chế, và nó cũng
  là điểm dễ bị lợi dụng nhất — nên phải chốt rất kỹ.
