...
Nhiều hệ recovery bắt người-bảo-chứng giữ một "mảnh" bí-mật của bạn — nếu họ thông-đồng hoặc bị hack, mất. PhoenixKey **đã bỏ hẳn mô-hình mảnh (Shamir)**. Người-bảo-chứng chỉ là một **khoá thành-viên ngủ-đông**: khi bạn còn khoẻ, khoá họ vô-hiệu; khi bạn cần, đủ số họ ký để uỷ-quyền đổi khoá cho bạn. Họ **không bao giờ thấy hay giữ** khoá/tài-sản của bạn. Hôm nay, đủ MỘT phương-thức đang dùng được là **người-bảo-chứng** (hoặc **Midnight** — một mạng blockchain khác, chuyên về giao-dịch riêng-tư, dùng ở đây làm một kênh chứng-thực độc-lập bên ngoài PhoenixKey, khi tích-hợp xong). Có một kênh thứ ba đang được đội VeData (nhóm làm công-cụ mật-mã riêng-tư cho cả hệ-thống, không phải đội xác-thực khuôn-mặt) chuẩn-bị: để một nhóm người-bảo-chứng đủ số-lượng chứng-thực cho bạn mà **không lộ họ là ai** trong nhóm đó. Kênh này **CHƯA xong và CHƯA dùng được** — hệ sẽ chặn thẳng nếu có ai cố dùng trước khi nó hoàn-tất, để không ai bị đẩy vào cảnh tưởng có đường khôi-phục mà thực ra không có.
