...
> Nguồn: `https://github.com/PhoenixKeyDID/PhoenixKey-Rebirthme-Specs/blob/main/PhoenixKey-Midnight-Privacy-Feat-DRAFT.md` — **DRAFT đề xuất, chưa duyệt**, mọi chi tiết Midnight đánh dấu `[GIẢ-ĐỊNH]` chờ Phase 1 PoC kiểm chứng. Ghi ở đây để không lạc trôi khỏi module Rebirthme (guardian recovery là trọng tâm); KHÔNG phải cam kết kỹ thuật, KHÔNG đổi thiết kế Tầng 1-6 ở trên.
...
> Fold từ `https://github.com/PhoenixKeyDID/PhoenixKey-Rebirthme-Specs/blob/main/PhoenixKey-Delegator-Core-Connector-Builders-Feat.md` (PR CORE, `rust_core`).
...
> Nguồn đầy đủ: `https://github.com/PhoenixKeyDID/PhoenixKey-Rebirthme-Specs/blob/main/PhoenixKey-Delegator-Claim-Offchain-Feat.md`. Mục này fold phần
...
> Nguồn: `https://github.com/PhoenixKeyDID/PhoenixKey-Rebirthme-Specs/blob/main/PhoenixKey-UI-Spec-Backup-Recovery-Lifecycle.md` (23 mục đầy đủ cho
...
Tài liệu cùng bộ: [PhoenixKey-Rebirthme-Math.md](./PhoenixKey-Rebirthme-Math.md), [PhoenixKey-Rebirthme-Vi-Feat.md](./PhoenixKey-Rebirthme-Vi-Feat.md), [PhoenixKey-Rebirthme-Exec.md](https://github.com/PhoenixKeyDID/PhoenixKey-Rebirthme-Specs/blob/main/PhoenixKey-Rebirthme-Exec.md).
