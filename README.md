...
**Kho công khai (repo này):** 8 module × 3 loại (Vi-Feat/Math/Tech) = **24 file** + 8 tài liệu cấp kho ([`Whitepaper`](./PhoenixKey-Whitepaper.md) tổng quan · `PhoenixKey-Math.md` toán tổng · [`PhoenixKey-DIDMethod-W3C.md`](./PhoenixKey-DIDMethod-W3C.md) chuẩn DID · [`PhoenixKey-SeedDistribution-Tech-Math.md`](./PhoenixKey-SeedDistribution-Tech-Math.md) phân tán seed/khoá · [`PhoenixKey-Wallet-API-v2-Feat.md`](./PhoenixKey-Wallet-API-v2-Feat.md) API ví · [`PhoenixKey-Wallet-Staking-Governance-Vi-Feat.md`](./PhoenixKey-Wallet-Staking-Governance-Vi-Feat.md) staking/quản trị Cardano/pool/SRCL · [`PhoenixKey-CustomBackend-Feat.md`](./PhoenixKey-CustomBackend-Feat.md) nguồn dữ liệu chain tự chọn · [`PhoenixKey-DappConnector-Feat.md`](./PhoenixKey-DappConnector-Feat.md) ví PhoenixKey kết nối dApp/sàn Cardano qua CIP-30) = **32 tài liệu spec** (+ `README`/`LICENSE`).
